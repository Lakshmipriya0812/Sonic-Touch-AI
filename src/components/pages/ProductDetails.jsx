...
const ProductDetail = () => {
  ...
  const { addToWishlist, isInWishlist, removeFromWishlist, isModalOpen: isWishlistModalOpen, closeModal: closeWishlistModal } = useWishlist();
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {product.color && product.color.length > 0 && (
                    <div>
                      <label className="block text-gray-700 font-medium mb-2">Select Color</label>
                      <select
                        value={selectedColor}
      ...
      <WishlistModal isOpen={isWishlistModalOpen} closeModal={closeWishlistModal} />
    </div>
  );
};
